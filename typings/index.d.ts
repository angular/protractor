...
// google3 local modification:
// Add namespace webdriver in the global namespace for backwards compatibility.
declare global {
namespace webdriver {
// end google3 local modification.
...
export class TargetLocator {
   ...
   */
  // google3 local modification. TargetLocator.frame accepts the null type.
...
export class WebDriver {
  ...
  /**
   * TEMPORARY API returns old ActionSequence so we can use actions() to
...
// google3 local modification:
}  // The close brace for "namespace webdriver"
}  // The closing brace for "declare global"
export = webdriver;
// end google3 local modification.
