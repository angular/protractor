...
Server to be running at http://localhost:4444 (use [webdriver-manager start](https://github.com/angular/protractor/blob/master/docs/server-setup.md#standalone-selenium-server)).
