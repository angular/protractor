 ...
 * @param {string=body} opt_appEl  Selector el that has an ng-app in scope
 * @constructor
 */
var Protractor = function(webdriver, opt_baseUrl, opt_appEl) {
...
Protractor.prototype.waitForAngular = function() {
  return this.driver.executeAsyncScript(clientSideScripts.waitForAngular, this.appEl);
};
 ...
 * @return {Protractor}
 */
exports.wrapDriver = function(webdriver, opt_baseUrl, opt_targetEl) {
  return new Protractor(webdriver, opt_baseUrl, opt_targetEl);
};
