...
var buildElementHelper = function(ptor) {
   ...
   * every element identified by the ElementArrayFinder. ElemeElementArrayFinder
   ...
   */
  var ElementArrayFinder = function(getWebElements, locator, opt_actionResults_) {
    this.getWebElements = getWebElements || null;
    this.actionResults_ = opt_actionResults_;
   ...
   *
   * @returentArrayFinder} which resolves to the
  ...
  var ElementFinder = function(elementArrayFinder) {
    ...
    // throw an error if there are no element. 
    var getWebElements = function() {
  ...
  ElementFinder.prototype.isPresent = function() {
    return this.elementArrayFinder_.getWebElements().then(function() {
      return true;
    }, function() {
      return false;
    });
