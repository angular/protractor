...
/**
 * Find element by directive name and value.
 *
 * arguments[0] {Element} The scope of the search.
 * arguments[1] {string} The directive name.
 * arguments[2] {string} The directive value.
 *
 * @return {Element} The first matching element.
*/
clientSideScripts.findDirective = function() {
  var using = arguments[0] || document;
  var directive = arguments[1];
  var value = arguments[2];
  var prefixes = ['ng-', 'ng_', 'data-ng-', 'x-ng-', 'ng\\:'];
  for (var p = 0; p < prefixes.length; ++p) {
    var selector = '[' + prefixes[p] + directive + '="' + value + '"]';
...
/**
 * Find elements by directive name and value.
 *
 * arguments[0] {Element} The scope of the search.
 * arguments[1] {string} The directive name.
 * arguments[2] {string} The directive value.
...
*/
clientSideScripts.findDirectives = function() {
  var using = arguments[0] || document;
  var directive = arguments[1];
  var value = arguments[2];
  var prefixes = ['ng-', 'ng_', 'data-ng-', 'x-ng-', 'ng\\:'];
