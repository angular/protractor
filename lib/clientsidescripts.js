 ...
 *
 * Asynchronous.
 * selector {string} The selector housing an ng-app
 ...
 *
 * binding {string} The binding, e.g. {{cat.name}}.
 * using {Element} The scope of the search.
 *
 ...
 *
 * repeater {string} The text of the repeater, e.g. 'cat in cats'.
 * index {number} The row index.
 * using {Element} The scope of the search.  Defaults to 'document'.
 *
 ...
 * repeater {string} The text of the repeater, e.g. 'cat in cats'.
 * index {number} The row index.
 * binding {string} The column binding, e.g. '{{cat.name}}'.
 * using {Element} The scope of the search.  Defaults to 'document'.
 *
 ...
 *
 * searchText {string} The exact text to match.
 * using {Element} The scope of the search.  Defaults to 'document'.
 *
 * @return {Array.<Element>} The matching elements.
 */
 ...
 *
 * Asynchronous.
 * attempts {number} Number of times to retry.
 ...
 *
 * element {Element} The element in whose scope to evaluate.
