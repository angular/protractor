export interface Config {
   ...
   * `multiCapabilities`.
   *
   * If this returns a promise, it is resolved immediately after `beforeLaunch`
   ...
   * should be longer than the maximum time your application needs to stabilize
   * between tasks.
   */
   ...
   * the preparation involves any asynchronous calls, e.g. interacting with the
