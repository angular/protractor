var protractor = require('./protractor'),
    ...
    AttachSession = require('./driverProviders/attachSession').AttachSession,
    BrowserStack = require('./driverProviders/browserStack').BrowserStack,
    Direct = require('./driverProviders/direct').Direct,
    Hosted = require('./driverProviders/hosted').Hosted,
    Local = require('./driverProviders/local').Local,
    Mock = require('./driverProviders/mock').Mock,
    Sauce = require('./driverProviders/sauce').Sauce;
...
Runner.prototype.loadDriverProvider_ = function() {
  ...
  if (this.config_.directConnect) {
    ...
    if (this.config_.seleniumSessionId) {
      console.log('attached the session');
