...
Runner.prototype.setupGlobals_ = function(browser) {
  ...
  global.createBrowser = this.createBrowser.bind(this);
 ...
 * future ones.
 *
 * @return {q.Promise} A promise which resolves to a protractor instance.
 * @public
 */
Runner.prototype.createBrowser = function() {
  var config = this.config_;
  var driver = this.driverprovider_.getDriver();
...
Runner.prototype.run = function() {
  ...
  // 2) Create a browser and setup globals
    ...
    self.setupGlobals_.bind(self)(browser); //TODO get rid of bind?
  // 3) Setup plugins
  }).then(function() {
