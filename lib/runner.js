...
Runner.prototype.run = function() {
  ...
  var specsWithSuites = this.config_.specs;

  // Put again the specs in its original shape for compatible code
  self.config_.specs = this.config_.specs.map(function(specInfo) {
  ...
  // 4) Execute test cases
    ...
    if (self.config_.framework === 'jasmine') {
      ...
      self.config_.specs = specsWithSuites;
