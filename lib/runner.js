...
/**
 * Resolve a list file patterns into a list of individual file paths.
 *
 * @param {array} patterns
 *
 * @return {array} The resolved file paths.
 */
var resolveFilePatterns = function(patterns) {
  var resolvedFiles = [];
...
var runTests = function() {
  ...
  var resolvedExcludes = resolveFilePatterns(config.excludes);
