...
var run = function() {
  if (config.jasmineNodeOpts.specFolders) {
    throw new Error('Using jasmineNodeOpts.specFolders is deprecated in ' +
        'Protractor 0.6.0. Please switch to jasmineNodeOpts.specs.');
  }
  // Check the spec folders.
  var specs = config.jasmineNodeOpts.specs;
