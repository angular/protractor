...
var Browser = (function (_super) {
     ...
     * capabilities object.
     */
    Browser.prototype.getProcessedConfig = function () { return null; };
    /**
     ...
     * Set by the runner.
     */
    Browser.prototype.restart = function () { return; };
    /**
    ...
    Browser.prototype.executeScript_ = function (script, description) {
        ...
        return this.driver.schedule(new ptor_1.protractor.Command(ptor_1.protractor.CommandName.EXECUTE_SCRIPT)
    ...
    Browser.prototype.executeAsyncScript_ = function (script, description) {
        ...
        return this.driver.schedule(new ptor_1.protractor.Command(ptor_1.protractor.CommandName.EXECUTE_ASYNC_SCRIPT)
            .setParameter('script', script)
            .setParameter('args', scriptArgs), description);
    };
    /**
    ...
    Browser.prototype.initDebugger_ = function (debuggerClientPath, onStartFn, opt_debugPort) {
        ...
        global.list = function (locator) {
            /* globals browser */
            return ptor_1.protractor.browser.findElements(locator).then(function (arr) {
                var found = [];
